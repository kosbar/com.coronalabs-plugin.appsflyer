...
build_plugin_structure "$path/BuiltPlugin/iphone" iphoneos  " -extract  arm64 "

build_plugin_structure "$path/BuiltPlugin/iphone-sim" iphonesimulator  "  -extract  x86_64 "
